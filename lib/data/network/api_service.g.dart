...
class _ApiService implements ApiService {
  ...
  Future<CinemetaManifest> isCinemetaApiLive() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<CinemetaManifest>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late CinemetaManifest _value;
    try {
      _value = CinemetaManifest.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<CinemetaCatalogue> getTopMovies() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<CinemetaCatalogue>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CinemetaCatalogue _value;
    try {
      _value = CinemetaCatalogue.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<CinemetaCatalogue> searchSeries(String query) async {
    ...
    final _options = _setStreamType<CinemetaCatalogue>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/catalog/series/top/search={query}.json',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<CinemetaMediaDetails> getMovieDetails(String tmdbId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<CinemetaMediaDetails>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CinemetaMediaDetails _value;
    try {
      _value = CinemetaMediaDetails.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
